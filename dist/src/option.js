...
const ERROR_MESSAGES = {
    ...
    OPTION_LONG_SHORT_EMPTY: 'Option schema must have either a long or short option',
...
class Option extends schemaValidator_1.default {
    constructor(option, _path) {
        ...
        if (!summary || this.isEmpty(summary)) {
            ...
            throw new optionSchemaMissingPropertyError_1.default('summary', JSON.stringify(option));
        }
        else {
        ...
        else if ((short !== undefined && short !== null && !this.isListOfStrings(short)) ||
        ...
        if (expectsArg !== undefined && expectsArg !== null && typeof expectsArg !== 'boolean') {
